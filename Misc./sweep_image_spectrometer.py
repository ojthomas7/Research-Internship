# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 12:20:20 2024
...
for i in range(N_wavelengths):
    ...
    if total_intensities is None:
        total_intensities = np.zeros_like(intensities)
    
    # Add current intensities to the cumulative sum
    ...
    plt.title(f'Cumulative Spectrum up to Iteration {iteration}')

    # Set x-axis limits to the range of scanned wavelengths
